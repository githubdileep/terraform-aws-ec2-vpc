...
# NAT Gateway lives in the first public subnet so private subnets get
# outbound internet access (e.g. for yum/apt updates) without being
# publicly reachable. Optional because it costs ~$0.045/hr + data.
